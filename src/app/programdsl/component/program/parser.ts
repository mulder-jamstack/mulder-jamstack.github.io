...
export class Parser {
    ...
    public matchRooms($$dpth: number, $$cr?: ErrorTracker): Nullable<Rooms> {
        return this.run<Rooms>($$dpth, () => {
            ...
            if (
                ...
                this.regexAccept(String.raw`(?:[Rr]ooms)`, $$dpth + 1, $$cr) !==
                    null &&
                this.loop<ENDLINE>(
                    () => this.matchENDLINE($$dpth + 1, $$cr),
                    true
                ) !== null &&
                ($scope$rooms = this.loop<Room>(
                    () => this.matchRoom($$dpth + 1, $$cr),
                    true
                )) !== null
            ) {
    ...
    public matchRoom($$dpth: number, $$cr?: ErrorTracker): Nullable<Room> {
        return this.run<Room>($$dpth, () => {
            ...
            if (
                ...
                this.match_($$dpth + 1, $$cr) !== null &&
                (($scope$capacite = this.matchRoom_$0($$dpth + 1, $$cr)) ||
                    true) &&
                this.loop<ENDLINE>(
                    () => this.matchENDLINE($$dpth + 1, $$cr),
                    true
    ...
    public matchPapers($$dpth: number, $$cr?: ErrorTracker): Nullable<Papers> {
        return this.run<Papers>($$dpth, () => {
            ...
            if (
                ...
                ($scope$papers = this.loop<Paper>(
                    () => this.matchPaper($$dpth + 1, $$cr),
                    true
                )) !== null
            ) {
        ...
        return this.run<Paper>($$dpth, () => {
            ...
            if (
                ...
                this.regexAccept(String.raw`(?:##)`, $$dpth + 1, $$cr) !==
                    null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                ($scope$paperName = this.matchSTRING($$dpth + 1, $$cr)) !==
                    null &&
                this.loop<ENDLINE>(
                    () => this.matchENDLINE($$dpth + 1, $$cr),
                    true
                ) !== null &&
                ($scope$authors = this.loop<Person>(
                    () => this.matchPerson($$dpth + 1, $$cr),
                    true
                )) !== null &&
                (($scope$abstract = this.matchAbstract($$dpth + 1, $$cr)) ||
                    true) &&
    ...
    public matchPerson($$dpth: number, $$cr?: ErrorTracker): Nullable<Person> {
        return this.run<Person>($$dpth, () => {
            ...
            if (
                ...
                this.match_($$dpth + 1, $$cr) !== null &&
                ($scope$name = this.matchSTRING($$dpth + 1, $$cr)) !== null &&
                (($scope$homepage = this.matchPerson_$0($$dpth + 1, $$cr)) ||
                    true) &&
                (($scope$email = this.matchPerson_$1($$dpth + 1, $$cr)) ||
                    true) &&
                (($scope$about = this.matchPerson_$2($$dpth + 1, $$cr)) ||
                    true) &&
                this.loop<ENDLINE>(
                    () => this.matchENDLINE($$dpth + 1, $$cr),
                    true
    ...
    public matchAbstract(
        ...
        return this.run<Abstract>($$dpth, () => {
            ...
            if (
                ...
                ($scope$text = this.matchMULTISTRING($$dpth + 1, $$cr)) !==
                    null &&
                this.loop<ENDLINE>(
                    () => this.matchENDLINE($$dpth + 1, $$cr),
                    true
    ...
    public matchEvents($$dpth: number, $$cr?: ErrorTracker): Nullable<Events> {
        return this.run<Events>($$dpth, () => {
            ...
            if (
                ...
                ($scope$events = this.loop<Event>(
                    () => this.matchEvent($$dpth + 1, $$cr),
                    true
                )) !== null
            ) {
    ...
    public matchSimpleEvent(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<SimpleEvent> {
        return this.run<SimpleEvent>($$dpth, () => {
            ...
            if (
                ...
                this.regexAccept(String.raw`(?:##)`, $$dpth + 1, $$cr) !==
                    null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                ($scope$eventName = this.matchSTRING($$dpth + 1, $$cr)) !==
                    null &&
                this.loop<ENDLINE>(
                    () => this.matchENDLINE($$dpth + 1, $$cr),
                    true
    ...
    public matchOrganizedEvent(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<OrganizedEvent> {
        return this.run<OrganizedEvent>($$dpth, () => {
            ...
            if (
                ...
                this.regexAccept(String.raw`(?:\()`, $$dpth + 1, $$cr) !==
                    null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                ($scope$eventType = this.matchSTRING($$dpth + 1, $$cr)) !==
                    null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                this.regexAccept(String.raw`(?:\))`, $$dpth + 1, $$cr) !==
                    null &&
                ...
                ($scope$organizers = this.loop<Person>(
                    () => this.matchPerson($$dpth + 1, $$cr),
                    true
                )) !== null &&
                (($scope$abstract = this.matchAbstract($$dpth + 1, $$cr)) ||
    ...
    public matchTalkSession(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<TalkSession> {
        return this.run<TalkSession>($$dpth, () => {
            ...
            if (
                ...
                ($scope$papers = this.loop<TalkSession_$0>(
                    () => this.matchTalkSession_$0($$dpth + 1, $$cr),
                    true
                )) !== null
            ) {
                $$res = {
    ...
    public matchTalkSession_$0(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<TalkSession_$0> {
    ...
    public matchProgram(
        ...
        return this.run<Program>($$dpth, () => {
            ...
            if (
                ...
                ($scope$days = this.loop<Day>(
                    () => this.matchDay($$dpth + 1, $$cr),
                    true
                )) !== null
            ) {
    ...
    public matchDay($$dpth: number, $$cr?: ErrorTracker): Nullable<Day> {
        return this.run<Day>($$dpth, () => {
            ...
            if (
                ...
                ($scope$eventinfo = this.loop<EventInfo>(
                    () => this.matchEventInfo($$dpth + 1, $$cr),
                    true
                )) !== null
            ) {
                $$res = {
        ...
        return this.run<EventInfo>($$dpth, () => {
            ...
            if (
                ...
                this.regexAccept(String.raw`(?:-)`, $$dpth + 1, $$cr) !==
                    null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                ($scope$timeSlot = this.matchEventInfo_$0($$dpth + 1, $$cr)) !==
                    null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                this.regexAccept(String.raw`(?:in)`, $$dpth + 1, $$cr) !==
                    null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                ($scope$roomName = this.matchSTRING($$dpth + 1, $$cr)) !==
                    null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                this.regexAccept(String.raw`(?::)`, $$dpth + 1, $$cr) !==
                    null &&
    ...
    public matchEventInfo_$0(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<EventInfo_$0> {
    ...
    public matchDATE($$dpth: number, $$cr?: ErrorTracker): Nullable<DATE> {
        return this.regexAccept(
            String.raw`(?:(19|20)[0-9][0-9]-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01]))`,
            $$dpth + 1,
            $$cr
        );
    }
    public matchHOUR($$dpth: number, $$cr?: ErrorTracker): Nullable<HOUR> {
        return this.regexAccept(
            String.raw`(?:(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9]))`,
            $$dpth + 1,
            $$cr
        );
    }
    public matchSTRING($$dpth: number, $$cr?: ErrorTracker): Nullable<STRING> {
        return this.regexAccept(
            String.raw`(?:[a-zA-Z0-9]([a-zA-Z0-9.\- ]*[a-zA-Z0-9.])?)`,
            $$dpth + 1,
            $$cr
        );
    }
    public matchMULTISTRING(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<MULTISTRING> {
        return this.regexAccept(
            String.raw`(?:([^\n\r]+\r?\n)*)`,
            $$dpth + 1,
            $$cr
